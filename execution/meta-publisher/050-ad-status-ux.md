...
- We want some kind of guardrail so that something that's been pushed up to meta becomes immutable in our systems. I.e., if we've published an ad, the image can no longer be regenerated or deleted etc. I'm not quite sure what the flow is, might be quite not exactly what I said but this needs thinking about. I think we want to display the Add Status in the Creative App and also, yeah, the Approved button or the ability to approve perhaps should be in the Creative App as well as the other one. But I think we should have that in the Creative App.
